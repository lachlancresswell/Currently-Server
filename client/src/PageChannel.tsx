...
export const PageChannel = ({ }: PageChannelProps) => {
    ...
    return (
        <div className="gridChannel">
            <PhaseRow phaseIndex={PHASE as 0 | 1 | 2} value={neighbourData?.phases[PHASE]!.voltage} prefix={'V'} type={'voltage'} neighbourData={neighbourData} />
            <ChannelRow className={'pf'} prefix={'pf'} neighbourData={neighbourData} phaseIndex={PHASE as 0 | 1 | 2} />
            <PhaseRow phaseIndex={PHASE as 0 | 1 | 2} value={neighbourData?.phases[PHASE]!.amperage} prefix={'A'} type={'amperage'} neighbourData={neighbourData} />
